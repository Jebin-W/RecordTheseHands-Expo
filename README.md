...
_Record These Hands!_ is an Android app that researchers can use to collect sign
...
we went about collecting it, please see our paper on the subject, _PopSign ASL
v1.0: An Isolated American Sign Language Dataset Collected via Smartphones_
...
_Record These Hands!_ in honor of a
...
- Users enter the app and see a simple home screen showing their progress. - Generally the app would be configured to be in "tutorial" mode. Which has a separate set of prompts which
